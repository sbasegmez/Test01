...
function setRating(ccId, panel, value) {
	...
	var img=dojo.query(".involveLoadingImgPanel", panelNode)[0];
	dojo.query("*", panelNode).style("display", "none");
	dojo.style(img, {
		"display": "",
		"width": pos.w+"px"
	});
...
function displayNewComment(commentListId) {
	...
	var divNode=dojo.query(".involveCommentListItemNew", wrapperNode)[0];
	var buttonNode=dojo.query(".involveCommentListSubHeaderAction", wrapperNode)[0];
